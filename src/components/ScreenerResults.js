...
const T = {
  en: {
    ...
    followUp1: "Not Required", followUp2: "Scheduled", followUp3: "Completed", followUp4: "Pending Review",
  ...
  af: {
    ...
    followUp1: "Nie Nodig", followUp2: "Geskeduleer", followUp3: "Voltooi", followUp4: "Wag op Hersiening",
  ...
  xh: {
    ...
    followUp1: "Ayifunekanga", followUp2: "Imiselwe", followUp3: "Iphelile", followUp4: "Ilindele",
...
const followUpColors = {
  followUp1: { bg: "#F7F6FF", color: "#8888a8" },
  followUp2: { bg: "#FEF0E7", color: "#F26522" },
  followUp3: { bg: "#E0F5F3", color: "#009B8D" },
  followUp4: { bg: "#FCE6EE", color: "#E8175D" },
};
...
const SEED_SESSIONS = [
  { childName: "Child PB-001", school: "Adelaide Primary", age: 5, language: "isiXhosa", score: 69, date: "2026-02-10", examiner: "Dr. Mokoena", status: "Progressing", stage: "stage4", followUpStage: "followUp1", cognitive: 72, motor: 85, language_score: 68, social: 60, emotion: 74, moral: 55 },
  { childName: "Child PB-002", school: "Adelaide Primary", age: 6, language: "isiXhosa", score: 42, date: "2026-02-10", examiner: "Dr. Mokoena", status: "Developmental Concerns", stage: "stage4", followUpStage: "followUp2", cognitive: 45, motor: 52, language_score: 40, social: 38, emotion: 42, moral: 35 },
  { childName: "Child PB-003", school: "Komani ECD", age: 5, language: "English", score: 88, date: "2026-02-14", examiner: "Dr. Mokoena", status: "On Track", stage: "stage4", followUpStage: "followUp1", cognitive: 88, motor: 92, language_score: 85, social: 90, emotion: 88, moral: 82 },
  { childName: "Child PB-004", school: "Komani ECD", age: 6, language: "Afrikaans", score: 34, date: "2026-02-14", examiner: "Dr. Mokoena", status: "Developmental Concerns", stage: "stage3", followUpStage: "followUp4", cognitive: 35, motor: 40, language_score: 32, social: 28, emotion: 38, moral: 30 },
  { childName: "Child PB-005", school: "Fort Beaufort", age: 5, language: "isiXhosa", score: 76, date: "2026-02-18", examiner: "Dr. Mokoena", status: "On Track", stage: "stage3", followUpStage: "followUp3", cognitive: 78, motor: 80, language_score: 75, social: 72, emotion: 79, moral: 70 },
  { childName: "Child PB-006", school: "Fort Beaufort", age: 6, language: "isiXhosa", score: 55, date: "2026-02-18", examiner: "Dr. Mokoena", status: "Progressing", stage: "stage2", followUpStage: "followUp2", cognitive: 55, motor: 60, language_score: 58, social: 52, emotion: 56, moral: 50 },
  { childName: "Child PB-007", school: "Stutterheim Primary", age: 5, language: "Afrikaans", score: 89, date: "2026-02-21", examiner: "Dr. Mokoena", status: "On Track", stage: "stage4", followUpStage: "followUp1", cognitive: 90, motor: 88, language_score: 92, social: 87, emotion: 91, moral: 85 },
  { childName: "Child PB-008", school: "Stutterheim Primary", age: 6, language: "English", score: 39, date: "2026-02-21", examiner: "Dr. Mokoena", status: "Developmental Concerns", stage: "stage2", followUpStage: "followUp4", cognitive: 42, motor: 38, language_score: 45, social: 35, emotion: 40, moral: 32 },
  { childName: "Child PB-009", school: "Adelaide Primary", age: 5, language: "isiXhosa", score: 65, date: "2026-02-25", examiner: "Dr. Mokoena", status: "Progressing", stage: "stage1", followUpStage: "followUp1", cognitive: 65, motor: 70, language_score: 62, social: 68, emotion: 66, moral: 60 },
  { childName: "Child PB-010", school: "Komani ECD", age: 6, language: "isiXhosa", score: 81, date: "2026-02-25", examiner: "Dr. Mokoena", status: "On Track", stage: "stage4", followUpStage: "followUp1", cognitive: 82, motor: 79, language_score: 84, social: 80, emotion: 83, moral: 78 },
  { childName: "Child PB-011", school: "Fort Beaufort", age: 5, language: "English", score: 30, date: "2026-03-03", examiner: "Dr. Mokoena", status: "Developmental Concerns", stage: "stage1", followUpStage: "followUp4", cognitive: 30, motor: 35, language_score: 28, social: 25, emotion: 32, moral: 27 },
  { childName: "Child PB-012", school: "Adelaide Primary", age: 6, language: "Afrikaans", score: 75, date: "2026-03-03", examiner: "Dr. Mokoena", status: "On Track", stage: "stage3", followUpStage: "followUp1", cognitive: 75, motor: 77, language_score: 73, social: 76, emotion: 74, moral: 72 },
  { childName: "Child PB-013", school: "Stutterheim Primary", age: 5, language: "isiXhosa", score: 57, date: "2026-03-07", examiner: "Dr. Mokoena", status: "Progressing", stage: "stage1", followUpStage: "followUp1", cognitive: 58, motor: 62, language_score: 55, social: 60, emotion: 57, moral: 52 },
  { childName: "Child PB-014", school: "Komani ECD", age: 6, language: "English", score: 47, date: "2026-03-07", examiner: "Dr. Mokoena", status: "Progressing", stage: "stage2", followUpStage: "followUp2", cognitive: 48, motor: 50, language_score: 46, social: 44, emotion: 49, moral: 43 },
  { childName: "Child PB-015", school: "Adelaide Primary", age: 5, language: "isiXhosa", score: 92, date: "2026-03-10", examiner: "Dr. Mokoena", status: "On Track", stage: "stage1", followUpStage: "followUp1", cognitive: 93, motor: 90, language_score: 95, social: 92, emotion: 94, moral: 88 },
];
      ...
      <div className="page-fade">
        <div className="card">
          <div className="empty-state">
            ...
            <div className="empty-state-sub">Setting up database for first time</div>
          </div>
        </div>
      </div>
    );
            ...
            <table className="data-table">
              ...
              <tbody>
                {filtered.map((s, i) => {
                  ...
                  const fc = followUpColors[s.followUpStage] || followUpColors.followUp1;
                  return (
                    <tr key={s.id || i}>
                      ...
                      <td>
                        <span style={{ display: "inline-block", padding: "4px 10px", borderRadius: 20, fontSize: 11, fontWeight: 700, background: fc.bg, color: fc.color }}>
                          {t[s.followUpStage] || s.followUpStage}
                        </span>
                      </td>
                      <td>
        ...
        <div className="modal-overlay" onClick={() => setSelected(null)}>
          <div className="modal" style={{ maxWidth: 560 }} onClick={e => e.stopPropagation()}>
            ...
            <div className="report-section">
              ...
              <div className="report-row">
                <span className="report-row-label">{t.followUp}</span>
                <span style={{ fontWeight: 700, color: followUpColors[selected.followUpStage]?.color }}>{t[selected.followUpStage]}</span>
              </div>
            </div>
